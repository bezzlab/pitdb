  ...
  if (path[0] == 'experiment'){
    switch (path[2]) {
      case 'PIT000001': //Oliver
        $("#description").html("<p>Data from a human ovarian cancer experiment. The whole transcriptome was sequenced for this experiment. Mass-spectrometry was carried out only on the extra cellular matrix. Tissues from different stage, grade have been used for this experiment to find underlying mechanism of drug response.</p><br/><p>Funded by: European Research Council (ERC322566); the Cancer Research UK (A16354)</p><br/><p style='font-size: 11px; font-style: italic;'>* Deconstructing a Metastatic Human Tumor Microenvironment. O.M.T. Pearce, R. Delaine-Smith, E. Maniati, S. Nichols, J. Wang, S. Böhm, V. Rajeeve, D. Ullah, P. Chakravarty, R.R. Jones, A. Monfort, T. Dowe, J. Connelly, J.D. Brenton, C. Chelala, P. R. Cutillas, M. Lockley, C. Bessant, M. Knight, F.R. Balkwill (submitted to Nature)</p>");
        break;
      case 'PIT000002': // Mosquito
        $("#description").html("<p>Data from the immortalised Aedes Aegypti (mosquito) cell line Aag2, commonly used for arbovirus research.</p><br/><p>Funded by: Medical Research Council (G0801973); Sir Henry Wellcome Fellowship (096062)</p><br/><p style='font-size: 11px; font-style: italic;'>* Proteomics Informed by Transcriptomics for Characterising Active Transposable Elements and Genome Annotation in Aedes Aegypti . K. Maringer, A. Yousuf, K.J. Heesom, J. Fan, A. Fernandez-Sesma, C. Bessant, D.A. Matthews, A.D. Davidson (submitted to BMC Biology)</p>");
        break;
